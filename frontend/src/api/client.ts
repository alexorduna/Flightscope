...
import type { ApiErrorResponse, FlightSearchResponse, PriceInsightsResponse } from "../types/api";
...
export function searchFlights(origin: string, destination: string, date: string): Promise<FlightSearchResponse> {
